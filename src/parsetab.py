...
_lr_signature = '8EA361D5F7B4E5A0C4947ACBD65F667A'
...
_lr_productions = [
  ...
  ('start -> compstmt','start',1,'p_start','parser.py',56),
  ('compstmt -> compstmt M_quad STMT','compstmt',3,'p_compstmt_1','parser.py',74),
  ('compstmt -> STMT complex1','compstmt',2,'p_compstmt_2','parser.py',83),
  ('STMT -> EXPR','STMT',1,'p_STMT','parser.py',92),
  ('EXPR -> RETURN ARG SemiColon','EXPR',3,'p_expre_return','parser.py',97),
  ('EXPR -> ARG','EXPR',1,'p_EXPR_new','parser.py',106),
  ('EXPR -> ARG M_quad SemiColon','EXPR',3,'p_EXPR','parser.py',111),
  ('ARG -> ARG Add ARG','ARG',3,'p_ARG_operations','parser.py',137),
  ('ARG -> ARG MINUS ARG','ARG',3,'p_ARG_operations','parser.py',138),
  ('ARG -> ARG Multiply ARG','ARG',3,'p_ARG_operations','parser.py',139),
  ('ARG -> ARG DIVIDE ARG','ARG',3,'p_ARG_operations','parser.py',140),
  ('ARG -> Identifier EQUALS ARG','ARG',3,'p_ARG_relational','parser.py',176),
  ('PRIMARY -> DEF Identifier ARGDECL DO compstmt END','PRIMARY',6,'p_PRIMARY_function','parser.py',218),
  ('complex145 -> empty','complex145',1,'p_complex145','parser.py',229),
  ('ARGDECL -> LPAREN ARGLIST RPAREN','ARGDECL',3,'p_ARGDECL','parser.py',246),
  ('ARGLIST -> Identifier complex2000','ARGLIST',2,'p_ARGLIST','parser.py',252),
  ('ARGLIST -> empty','ARGLIST',1,'p_ARGLIST','parser.py',253),
  ('complex2000 -> Seperator Identifier complex2000','complex2000',3,'p_complex2000','parser.py',262),
  ('complex2000 -> empty','complex2000',1,'p_complex2000','parser.py',263),
  ('complex169 -> empty','complex169',1,'p_complex169','parser.py',271),
  ('ARG -> PRIMARY','ARG',1,'p_ARG_others','parser.py',284),
  ('VARIABLE -> VARNAME','VARIABLE',1,'p_variable','parser.py',295),
  ('LITERAL -> FPNUMBER','LITERAL',1,'p_literal_fpnumber','parser.py',303),
  ('LHS -> VARIABLE','LHS',1,'p_LHS','parser.py',310),
  ('VARNAME -> Identifier','VARNAME',1,'p_varname','parser.py',317),
  ('PRIMARY -> VARIABLE','PRIMARY',1,'p_PRIMARY_variable','parser.py',340),
  ('ARG -> ARG less_than ARG','ARG',3,'p_relation_operations','parser.py',347),
  ('ARG -> ARG greater_than ARG','ARG',3,'p_relation_operations','parser.py',348),
  ('ARG -> ARG lessthan_equals ARG','ARG',3,'p_relation_operations','parser.py',349),
  ('ARG -> ARG greater_than_equals ARG','ARG',3,'p_relation_operations','parser.py',350),
  ('ARG -> ARG double_equals ARG','ARG',3,'p_relation_operations','parser.py',351),
  ('ARG -> ARG Exclaim1 ARG','ARG',3,'p_relation_operations','parser.py',352),
  ('PRIMARY -> WHILE M_quad EXPR DO M_while compstmt END','PRIMARY',7,'p_PRIMARY_conditionals','parser.py',389),
  ('M_while -> empty','M_while',1,'p_m_while','parser.py',411),
  ('M_quad -> empty','M_quad',1,'p_mark','parser.py',420),
  ('PRIMARY -> LITERAL','PRIMARY',1,'p_PRIMARY_LITERAL','parser.py',430),
  ('LITERAL -> STRING','LITERAL',1,'p_literal_string','parser.py',461),
  ('LITERAL -> NUMBER','LITERAL',1,'p_literal_number','parser.py',468),
  ('complex1 -> empty','complex1',1,'p_complex1','parser.py',474),
